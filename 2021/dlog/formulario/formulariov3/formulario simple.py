...
def insertar ():
    ...
    instruccion="INSERT INTO Usuarios('nombre', 'apellido', 'calle', 'numero', 'telefono', 'localidad', 'estadocivil', 'nombreusuario', 'password') VALUES ('%s', '%s','%s','%d','%d','%s','%d','%s','%s')" % (Inombre, Iapellido, Icalle, Inumero, Itelefono, Ilocalidad, Iestado, Iusuario, Iclave)
